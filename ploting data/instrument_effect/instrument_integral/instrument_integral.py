...
cases = ["20_horizontal", "20_lateral", "30_horizontal", "30_lateral", "40_horizontal", "40_lateral"]
...
ax.set_ylabel('Surface integral of Hcl mass fraction on instrument($m^2$)')
...
plt.savefig("Surface integral of mass fraction of Hcl on instruments.png")
# 显示柱状图
plt.show()
