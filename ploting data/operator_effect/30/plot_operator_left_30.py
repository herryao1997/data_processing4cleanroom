...
# 读取文件2的数据
x2, y2 = read_data(os.path.join(lateral, filename_l1))

# 读取文件3的数据
x3, y3 = read_data(os.path.join(horizontal, filename_l2))
# 读取文件4的数据
x4, y4 = read_data(os.path.join(lateral, filename_l2))
# # 读取文件5的数据
...
plt.savefig("30_left_operator_average.png")
# 显示图表
plt.show()
