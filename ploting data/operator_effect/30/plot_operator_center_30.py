...
# 读取文件1的数据
x1, y1 = read_data(os.path.join(horizontal, filename_c1))
# 读取文件2的数据
x2, y2 = read_data(os.path.join(lateral, filename_c1))

# # 读取文件3的数据
# x3, y3 = read_data(os.path.join(horizontal, filename_c2))
# # 读取文件4的数据
...
plt.savefig("30_center_operator_average.png")
# 显示图表
plt.show()
